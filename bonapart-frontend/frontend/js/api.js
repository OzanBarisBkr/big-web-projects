    ...
    var objectItems =
        ...
        function deneme(){
            ...
            $(".product-class").click(function(){
                ...
                $(".product-search-area .select-box").click(function(){
