        ...
        function deneme(){
            ...
            $(".product-class").click(function(){
                ...
                $('.product-search-area #click-link').on('click', function (){
                    ...
                    // $('.product-search-area').css('height', '50%!important');
                    $('.product-search-area').removeClass('active-before-2');
                    //like
